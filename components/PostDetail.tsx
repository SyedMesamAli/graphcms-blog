...
import { PropType } from '../pages/post/[slug]'

const PostDetail = ({ post }: PropType) => {
    interface ObjectType {
        [key: string]: any
    }
    const getContentFragment = (index: number, text: any, obj: ObjectType, type?: string) => {
        ...
        <div className='bg-white shadow-lg rounded-lg lg:p-8 pb-12 mb-8'>
            ...
            <div className='px-4 lg:px-0'>
                ...
                {post.content.raw.children.map((typeObj: any, index) => {
                    const children = typeObj.children.map((item: ObjectType, itemIndex: number) => getContentFragment(itemIndex, item.text, item))
